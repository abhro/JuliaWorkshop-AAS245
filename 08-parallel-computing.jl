...
# ╔═╡ 4cc872eb-bd6c-4efe-a6e6-ad96c6493861
md"""
...
# ╔═╡ 880b3808-5aec-4936-be0b-f041b174fa8c
md"""
## Single Processor Parallelism (SIMD)
"""

# ╔═╡ 33472c54-3699-4025-b940-6669985b4ecd
md"""
...
!!! note
    ...
    python vectorization refers to placing all your variables in some vector container, like
    a numpy array, so that the resulting operation is run using a C/Fortran library.
"""
...
# ╔═╡ d046684e-ce49-4cae-bb77-abadf9a6bced
md"""
...
# ╔═╡ e0240d71-ad5d-4137-8504-99ef99e4e02f
md"""
...
# ╔═╡ 18bb0b42-1311-49b6-a0a4-cce4b18185d5
md"""
...
# ╔═╡ c007449f-ec14-4c23-80f3-14f8862750fc
md"""
...
# ╔═╡ c30dc843-3ce1-4e86-9593-1a9cbb3dd113
md"""
...
# ╔═╡ f1277055-0f0c-4418-940a-99ca089e2bd2
md"""
### Using Higher-Level Threading Packages
"""

# ╔═╡ c22caadd-ec8c-4a59-afe9-4da693dd58dc
md"""
...
# ╔═╡ 52013809-ab88-4fe5-a3a9-2bd0c7cb530f
md"""
## GPU Acceleration
"""

# ╔═╡ 1d178fa8-df7a-41aa-819f-d037e954d105
md"""
### Introduction
"""

# ╔═╡ 50c751cf-6790-4792-a1c2-7fea32bdda22
md"""
...
# ╔═╡ ffb0586f-c22d-4a1d-b4f7-2ffd1c51e013
md"""
...
# ╔═╡ f11075bf-0548-4096-a243-0a80ad172e76
md"""
### GPU caveats
"""

# ╔═╡ abdfe475-009f-4ed9-877f-8c0b72be32f7
md"""
...
# ╔═╡ 3d38f322-99dd-4d9d-915d-52028ac555da
md"""
## Distributed Computing (Switch to the REPL here)
"""

# ╔═╡ f5e1e572-d747-40b2-9096-417a05bf3c30
md"""
...
# ╔═╡ e11f2047-f481-428c-b4b3-2185f8220c43
md"""
### Distributed.jl (Manager-Worker parallelism)
"""

# ╔═╡ 0837804e-b940-4b73-b187-8d37b5cf7548
md"""
...
# ╔═╡ 03ef5344-ef68-40d9-9039-9eab8a666885
md"""
### Loading modules on a Distributed system
"""

# ╔═╡ e2ecd403-80c7-4156-b408-c8d9e925b666
md"""
...
# ╔═╡ 2a3d7c6d-1808-438e-972b-e9663e57a8ff
md"""
### Distributed computation
"""

# ╔═╡ 5f904beb-c835-4a8f-9138-7ba9a5cc27e2
md"""
...
# ╔═╡ adc33bd5-55de-4daa-a328-5a340efab58e
md"""
## Conclusion
"""

# ╔═╡ 13b23e23-85c9-44e9-8135-69b1a78e6436
md"""
